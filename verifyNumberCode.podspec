#
#  Be sure to run `pod spec lint verifyNumberCode.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "xie" => "1310377753@qq.com" }
  # Or just: s.author    = "xie"
  # s.authors            = { "xie" => "1310377753@qq.com" }
